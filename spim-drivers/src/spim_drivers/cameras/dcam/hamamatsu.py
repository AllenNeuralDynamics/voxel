...
from spim_rig.camera.base import FrameRegion, PixelFormat, SpimCamera, StreamInfo, TriggerMode, TriggerPolarity
...
# Pixel format mapping: DCAM format -> SpimCamera format
...
class HamamatsuCamera(SpimCamera):
    """Hamamatsu camera driver using DCAM SDK.
