"""DAQ agent - wraps SpimDaq and provides async task management."""
...
class DaqAgent(DeviceAgent[SpimDaq]):
    """Agent for SpimDaq devices with async task management."""
