...
from spim_qt.ui.launch.new_session_form import NewSessionForm
from spim_qt.ui.launch.session_list import SessionList
from spim_qt.ui.primitives.display import Label
from spim_qt.ui.theme import Colors

if TYPE_CHECKING:
    from spim_qt.app import SpimQtApp
    from spim_studio.system import SessionDirectory
...
class LaunchPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        header_layout.addWidget(Label("SPIM Qt", variant="title", color=Colors.TEXT_BRIGHT))
