"""SPIM Qt application entry point with qasync event loop integration."""
...
def create_qapp() -> QApplication:
    ...
    qapp.setApplicationName("SPIM Qt")
...
def run_app(config_path: Path | None = None) -> int:
    """Run the SPIM Qt application with qasync event loop.
    ...
    async def _setup_and_run() -> None:
        ...
        log.info("SPIM Qt application started")
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="SPIM Qt - Microscope control application",
