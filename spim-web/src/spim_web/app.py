"""CLI for SPIM - Run rig controller or node services.
...
def run_rig(args: argparse.Namespace) -> None:
    ...
    log = logging.getLogger("spim.app")
...
def node_main() -> None:
    """Entry point for spim-node command (backward compatibility)."""
