...
def _create_lifespan(system_config: SystemConfig):
    ...
    async def lifespan(app: FastAPI):
        ...
        log.info("Starting SPIM Studio in lobby mode")
...
def create_app(system_config: SystemConfig | None = None, serve_static: bool = True) -> FastAPI:
    ...
    Args:
        system_config: System configuration. If None, loads from ~/.spim/system.yaml.
    ...
    app = FastAPI(
        title="SPIM Studio API",
        description="Web API for SPIM microscope control",
        version="0.1.0",
