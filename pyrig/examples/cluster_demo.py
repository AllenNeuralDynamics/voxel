"""Demo script for pyrig cluster functionality."""
...
import zmq.asyncio
from pyrig.cluster.transport import DeviceAddressTCP, ZMQAdapter, ZMQService
from pyrig.device import Device, DeviceController, DeviceHandle, PropsResponse, describe
...
class DataProcessor(Device):
    ...
    COMMANDS: ClassVar[set[str]] = {"get_status"}
...
class Laser(Device):
    ...
    COMMANDS: ClassVar[set[str]] = {"turn_on", "turn_off"}
