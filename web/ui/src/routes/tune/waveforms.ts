// Pure waveform trace-generation for the tune view. Wire types live in `$lib/model`; this module
// holds only the behavior (config → sample arrays, axis bounds, ticks). Sole consumer is the tune route.
