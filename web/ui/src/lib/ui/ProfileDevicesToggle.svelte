<script lang="ts">
	...
	function isFilterWheel(config: VoxelRigConfig, deviceId: string): boolean {
	...
	function buildGroupsFlat(config: VoxelRigConfig, channels: Record<string, ChannelConfig>): DeviceGroup[] {
	...
	function buildGroupsByType(config: VoxelRigConfig, channels: Record<string, ChannelConfig>): DeviceGroup[] {
	...
	function buildGroupsByPath(config: VoxelRigConfig, channels: Record<string, ChannelConfig>): DeviceGroup[] {
	...
	function buildGroupsByChannel(config: VoxelRigConfig, channels: Record<string, ChannelConfig>): DeviceGroup[] {
