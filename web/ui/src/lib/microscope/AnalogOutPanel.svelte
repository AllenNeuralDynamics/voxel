<script lang="ts">
  ...
  import { generateTraces, niceTicks, resolveWaveforms, voltageRange } from '$lib/waveform';
  import { type DerivedWaveform, isDerivedWaveform, type Waveform } from '$lib/waveform';
