"""Simple device implementations for the basic rigup example.

These devices demonstrate rigup's capabilities with domain-relevant examples:
...
from rigup.device import Device, describe
...
class TemperatureController(Device):
    ...
    __COMMANDS__: ClassVar[set[str]] = {"start_regulation", "stop_regulation", "reset"}
...
class MotorStage(Device):
    ...
    __COMMANDS__: ClassVar[set[str]] = {"move_absolute", "move_relative", "home", "stop"}
...
class Pump(Device):
    ...
    __COMMANDS__: ClassVar[set[str]] = {"start", "stop", "dispense_volume"}
