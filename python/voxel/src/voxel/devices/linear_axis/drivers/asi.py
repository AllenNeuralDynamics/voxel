...
class ASITigerLinearAxis(VoxelLinearAxis):
    ...
    def position_mm(self) -> float:
        return self._tigerbox.get_axis_position(self.uid)

    @position_mm.setter
    def position_mm(self, value: float) -> None:
        self._tigerbox.move_absolute_mm(self.uid, value)

    @property
    def upper_limit_mm(self) -> float:
        return self._tigerbox.get_upper_travel_limit(self.uid)

    @upper_limit_mm.setter
    def upper_limit_mm(self, upper_limit_mm: float) -> None:
        self._tigerbox.set_upper_travel_limit(self.uid, upper_limit_mm)

    def set_upper_limit_mm_in_place(self) -> None:
        self._tigerbox.set_upper_travel_limit_in_place(self.uid)

    @property
    def lower_limit_mm(self) -> float:
        return self._tigerbox.get_lower_travel_limit(self.uid)

    @lower_limit_mm.setter
    def lower_limit_mm(self, lower_limit_mm: float) -> None:
        self._tigerbox.set_lower_travel_limit(self.uid, lower_limit_mm)

    def set_lower_limit_mm_in_place(self) -> None:
        self._tigerbox.set_lower_travel_limit_in_place(self.uid)

    @property
    def is_moving(self) -> bool:
        return self._tigerbox.is_axis_moving(self.uid)
    ...
    def home_position_mm(self) -> float:
        return self._tigerbox.get_axis_home_position(self.uid)
    ...
    def set_home_position(self, home_position: float | None = None) -> None:
        ...
        self._tigerbox.set_axis_home_position(self.uid, home_position)

    def home(self, *, wait: bool = False) -> None:
        """Move the axis to the home position."""
        self._tigerbox.home(self.uid)
        if wait:
            self.await_movement()
    ...
    def go_to_origin(self, *, wait: bool = False) -> None:
    ...
    def speed_mm_s(self) -> float:
        return self._tigerbox.get_axis_speed(self.uid)

    @speed_mm_s.setter
    def speed_mm_s(self, value: float) -> None:
        self._tigerbox.set_axis_speed(axis_name=self.uid, speed_mm_s=value)

    @property
    def acceleration_ms(self) -> float:
        return self._tigerbox.get_axis_acceleration(axis_name=self.uid)

    @acceleration_ms.setter
    def acceleration_ms(self, value: float) -> None:
        self._tigerbox.set_axis_acceleration(axis_name=self.uid, acceleration_ms=value)

    def set_backlash_mm(self, value: float) -> None:
        self._tigerbox.set_axis_backlash(axis_name=self.uid, backlash_mm=value)
    ...
    def set_joystick_polarity(self, polarity: Literal[1, -1]) -> None:
        self._tigerbox.set_axis_joystick_polarity(self.uid, polarity)

    def enable_joystick(self) -> None:
        self._tigerbox.enable_axis_joystick_input(self.uid)

    def disable_joystick(self) -> None:
        self._tigerbox.disable_axis_joystick_input(self.uid)
