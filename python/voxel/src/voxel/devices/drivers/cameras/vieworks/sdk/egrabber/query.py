...
def features_of(category, available_only=True):
    ...
    """
    return _handler(
        cE.Eur_query_featuresOf__from__const_char_p__bool8_t, utils.to_cstr(category), ct.c_ubyte(available_only)
    )
...
def categories_of(category, available_only=True):
    ...
    """
    return _handler(
        cE.Eur_query_categoriesOf__from__const_char_p__bool8_t, utils.to_cstr(category), ct.c_ubyte(available_only)
    )
...
def enum_entries(feature, available_only=True):
    ...
    """
    return _handler(
        cE.Eur_query_enumEntries__from__const_char_p__bool8_t, utils.to_cstr(feature), ct.c_ubyte(available_only)
    )
