...
``FrameTiming`` / ``SyncTriggerConfig`` are imported from the old ``vxl2.sync``
...
from vxl2.daq import AcqSampleMode, DaqHandle
from vxl2.daq.wave import Waveform
...
class SyncTask:
    ...
    async def close(self) -> None:
        ...
        we log and continue; rigur's cluster close downstream force-terminates
