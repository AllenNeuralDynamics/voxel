...
from rigur import deliminated_float, describe
from vxl2.aotf.base import AOTF
from vxl2.laser.base import Laser
...
class SimulatedAOTFShutteredLaser(Laser):
    ...
    Args:
        ...
        aotf: Reference to the AOTF device (resolved by rigur from device ID).
