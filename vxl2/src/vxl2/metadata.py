...
ENTRY_POINT_GROUP = "vxl2.metadata"
BASE_METADATA_SCHEMA = "vxl2.metadata.ExperimentMetadata"
...
def resolve_metadata_class(target: str) -> type[ExperimentMetadata]:
    """Import a metadata class from a dotted target path (e.g. 'vxl2.metadata.ExaspimMetadata')."""
